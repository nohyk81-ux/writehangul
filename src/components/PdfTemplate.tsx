        ...
        >
          ...
          <div className="w-full relative z-10 flex flex-col h-full">
            ...
            <div className="text-center mb-[8mm]">
              <h1 className="text-2xl font-bold font-sans tracking-wider text-muk">
                {t('pdfHeader')}
              </h1>
            </div>
            
            {/* MAIN GRID */}
            <div className="grid grid-cols-6 grid-rows-8 w-full flex-1 border-t-[1.5px] border-l-[1.5px]" style={{ borderColor: 'rgba(231, 76, 60, 0.5)' }}>
              {cells.map((char, idx) => (
                <div key={idx} className="border-b-[1.5px] border-r-[1.5px] flex items-center justify-center relative bg-white/50" style={{ borderColor: 'rgba(231, 76, 60, 0.5)' }}>
                  {/* Guidelines */}
                  ...
                  {/* Character */}
                  {char && (
                    <span className="font-sans font-medium text-[42pt] relative z-10 leading-none pb-2" style={{ color: 'rgba(44, 62, 80, 0.25)' }}>
                      {char}
                    </span>
                  )}
                </div>
            ...
            {/* FOOTER */}
            <div className="flex justify-between items-end mt-[6mm]">
