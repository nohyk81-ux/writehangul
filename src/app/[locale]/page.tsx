  ...
  return (
    <main className="flex-1 flex flex-col p-4 md:p-8 max-w-7xl mx-auto w-full print:p-0 print:m-0 print:max-w-none relative">
      ...
      <section className="mb-6 print:hidden mt-2">
        <div className="bg-blue-100 rounded-xl p-[4vw] md:p-8 flex items-center justify-center gap-[3vw] md:gap-16 shadow-sm border border-blue-200 relative overflow-hidden">
          ...
          <div className="text-left relative z-10 whitespace-nowrap">
            <h2 className="text-[4vw] sm:text-[3.5vw] md:text-4xl font-bold text-muk mb-1 md:mb-2 leading-tight" dangerouslySetInnerHTML={{ __html: t('title') }}></h2>
            <p className="text-muk/80 text-[2.5vw] sm:text-[2vw] md:text-lg mb-1 md:mb-2 font-medium" dangerouslySetInnerHTML={{ __html: t('subtitle') }}></p>
            <p className="font-bold text-[3.5vw] sm:text-[3vw] md:text-2xl text-muk mt-1 md:mt-4">{t('highlight')}</p>
          </div>
        </div>
      </section>
